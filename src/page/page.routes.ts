...
PageRoutes.put('/pages/:pageId/elements/positions', AuthenticatedUserMiddleware, CanEditPageMiddleware, HtmlElementController.prototype.updateElementsPositions);
